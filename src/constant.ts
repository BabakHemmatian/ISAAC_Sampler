export const UI_TEXT = {
  ...
  emailQueuedMessage: "Your request was submitted. We will email your download link when the file is ready.",
  stop: "Stop",
  ...
  snackbar: {
    ...
    emailQueued: "Your request was submitted. We will email the download link when it is ready.",
