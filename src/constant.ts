export const UI_TEXT = {
  ...
  homeSubtitle:
  "This tool allows you to download either the <strong>entirety</strong> or a <strong>random subset</strong> of the labeled discourse related to each of the six social groups included in ISAAC. Just choose a social group and a continuous timeframe between Jan 2007 and Dec 2023, then click <strong>Generate Sample</strong>.<br><br><strong>Note:</strong> If no document count is indicated, the website will return all relevant data. If a certain number is entered for the sample size, the tool will generate a random set of documents sampled equally from each included month. For the definition of each column in the output, please see <a href='https://github.com/BabakHemmatian/Illinois_Social_Attitudes/blob/main/variable_list.md' style='color: red;'>here</a>.",
